...
#region Functions
        ...
        {
            AuraCamera[] auraCameras = AuraCamera.FindObjectsByType<AuraCamera>(FindObjectsSortMode.None);
        ...
        {
            return AuraVolume.FindObjectsByType<AuraVolume>(FindObjectsSortMode.None);
        }
        ...
        {
            return AuraLight.FindObjectsByType<AuraLight>(FindObjectsSortMode.None);
        }
...
#region Add Aura to GameObjects
        ...
        {
            Camera[] camerasArray = GameObject.FindObjectsByType<Camera>(FindObjectsSortMode.None);
        ...
        {
            Light[] lightsArray = GameObject.FindObjectsByType<Light>(FindObjectsSortMode.None);
